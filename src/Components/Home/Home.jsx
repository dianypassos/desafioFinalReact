...
import fundoVerde from "../../assets/images/cordefundo_verde1.png"
import fundoVermelho from "../../assets/images/corefundo_vermelha2.png"
import fundoAmarelo from "../../assets/images/cordefundo_Amarela2.png"
import {MainStyle, Copo, Section, H2, H1, P, Button, ContainerText, Div, Fundo} from "./style"
    ...
    return(
        <MainStyle>
            ...
            <Section>
                ...
                <Fundo src={corDeFundo} alt="Cor de fundo" />
            </Section>
        </MainStyle>
    )
}